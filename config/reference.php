 ...
 *             mime_types?: mixed, // File extensions to mime types map. // Default: []
 *         },
 *         exception_handler?: Param|string|array{
 *             type?: "json"|"production"|"symfony"|"custom"|"auto"|Param, // Default: "auto"
 *             verbosity?: "trace"|"verbose"|"default"|"auto"|Param, // Default: "auto"
 *             handler_id?: scalar|Param|null, // Default: null
 *         },
 *         services?: array{
 *             debug_handler?: bool|Param|null, // Deprecated: The "debug_handler" option is deprecated. It is no longer needed to provide debug http kernel. // Default: null
 *             trust_all_proxies_handler?: bool|Param, // Default: false
 *             cloudfront_proto_header_handler?: bool|Param, // Default: false
 *             blackfire_profiler?: bool|Param, // Default: false
 *             blackfire_monitoring?: bool|Param, // Default: false
 *             tideways_apm?: array{
 *                 enabled?: bool|Param, // Default: false
 ...
 *                 register_monolog_formatter_service?: scalar|Param|null, // Default: null
 *                 monolog_formatter_service_name?: scalar|Param|null, // Default: null
 *                 monolog_formatter_format?: scalar|Param|null, // Default: null
 *             },
 *         },
 *         settings?: array{
 *             log_file?: scalar|Param|null, // Default: "%kernel.logs_dir%/swoole_%kernel.environment%.log"
 *             log_level?: "auto"|"debug"|"trace"|"info"|"notice"|"warning"|"error"|Param, // Default: "auto"
 *             pid_file?: scalar|Param|null, // Default: null
 *             buffer_output_size?: scalar|Param|null, // Default: 2097152
 *             package_max_length?: scalar|Param|null, // Default: 8388608
 ...
 *             http_compression?: bool|Param, // Default: false
 *             http_compression_level?: scalar|Param|null, // Default: 4
 *         },
 *     },
 *     task_worker?: array{
 *         services?: array{
 *             reset_handler?: bool|Param, // Default: true
 *         },
 *         settings?: array{
 ...
 *             max_concurrency?: scalar|Param|null, // Default: null
 *             max_service_instances?: scalar|Param|null, // Default: null
 *             stateful_services?: list<scalar|Param|null>,
 *             compile_processors?: list<Param|string|array{ // Default: []
 *                 class?: scalar|Param|null,
 *                 priority?: int|Param, // Default: 0
 *                 config?: list<mixed>,
 *             }>,
 *             doctrine_processor_config?: array{
 *                 global_limit?: int|Param, // Default: null
 ...
 * }
 * @psalm-type SwooleBundleResetterConfig = array{
 *     exclude_from_processing?: array{
 *         entity_managers?: list<scalar|Param|null>,
 *         connections?: array{
 *             dbal?: list<scalar|Param|null>,
 *             redis_cluster?: list<scalar|Param|null>,
 *         },
 *     },
 *     ping_interval?: scalar|Param|null, // Default: false
 *     check_active_transactions?: bool|Param, // Default: false
 ...
 *     },
 * }
 * @psalm-type NovawayFeatureFlagConfig = array{
 *     default_manager?: scalar|Param|null, // Default: "default"
