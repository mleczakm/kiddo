...
final class NewsletterConfirmationActionTest extends WebTestCase
{
    public function testPolishRouteRenders(): void
    {
        ...
        static::assertStringContainsString('Zapis potwierdzony!', (string) $client->getResponse()->getContent());
    }
    ...
    public function testEnglishRouteRenders(): void
    {
        ...
        self::assertResponseIsSuccessful();
        static::assertStringContainsString('Subscription confirmed!', (string) $client->getResponse()->getContent());
    }
}
